...
bnd_pwr_0_25	bnd_pwr_25_50	bnd_pwr_50_150	entropy	kurt	sknew	flatness	ratio_25	ratio_50	filename

output_cols=['bnd_pwr_0_25','bnd_pwr_25_50','bnd_pwr_50_150','entropy','kurt','sknew','flatness','ratio_25', 'ratio_50','ratio_150','perm_ent', 'filename', 'labels']
...
for idx,row in df_info.iterrows():
    ...
    file_path='/media/shruti/Data/Breathing_project/Tiles/br_stft20_fft5_fts/'+sub_nm+'.csv'
